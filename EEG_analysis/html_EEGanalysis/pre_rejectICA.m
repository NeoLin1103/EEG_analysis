...
% Ofile_struct_list_set = dir([html.originpath filesep '*.set']); 
...
% EEG = pop_loadset('filename', Ofile_struct_list_set{1}, 'filepath', html.originpath);
originalEEG = EEG;
